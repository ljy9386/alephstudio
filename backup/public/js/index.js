...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function initAboutShader() {
        ...
        function initAbout() {
            ...
            aboutScene.background = new THREE.Color(0xffffff);
    ...
    function initWorksAnimation() {
        ...
        function initWorks() {
            ...
            worksScene.background = new THREE.Color(0xffffff);
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (contactForm) {
        contactForm.addEventListener('submit', function(e) {
            ...
            // 이메일 클라이언트로 이동
            const mailtoLink = `mailto:contact@alephstudio.com?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(body)}`;
            ...
            // 성공 메시지 (선택사항)
            alert('이메일 클라이언트가 열렸습니다. 메시지를 작성해주세요.');
        });
    }
});
